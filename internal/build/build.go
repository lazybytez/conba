...
var Version = "edge" //nolint:gochecknoglobals // ldflags injection target

// CommitSHA is the git commit hash, injected via ldflags.
// Defaults to "unknown" when not set at build time.
var CommitSHA = "unknown" //nolint:gochecknoglobals // ldflags injection target
...
var ResticVersion = "0.18.1" //nolint:gochecknoglobals // ldflags injection target
